...
<h2 align="right">1.1. INTRODUÇÃO 📰</h2>

Código desenvolvido durante a disciplina Desenvolvimento WEB.

<h2 align="right">1.2. DESCRIÇÃO 📝</h2>

Trata de u exemplo da utrilização do HTML.

<h2 align="right">1.3. TECNOLOGIAS 💻</h2>
